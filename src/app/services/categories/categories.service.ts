...
export class CategoriesService {
  ...
  getAllCategories(): Observable<Array<GetAllCategories>>{
    return this.http.get<Array<GetAllCategories>>(
      `${this.API_URL}/categories`,
      this.httpOptions
    )
  }

  createCategory(requestDatas: {name: string}): Observable<Array<GetAllCategories>>{
    return this.http.post<Array<GetAllCategories>>(
